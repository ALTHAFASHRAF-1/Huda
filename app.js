...
async function login() {
    ...
    loadEvents(),
    loadTimeTable(),
    checkOverdueTasks() // Add this line
]);
...
// Add this function after your existing task functions
...
// Call this function at the end of loadTasks()
// Add this line at the end of the loadTasks() function:
// showOverdueTasksSummary();
...
// Modified showSignup function with hash update
function showSignup() {
...
// Modified showLogin function with hash update
function showLogin() {
    document.getElementById('signupSection').classList.add('hidden');
...
// Modified logout function to clear hash
function logout() {
    currentUser = null;
    api.clearCache();
    document.getElementById('loginPage').classList.remove('hidden');
